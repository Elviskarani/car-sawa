...
import DealerCard from '@/components/DealerCard'; // Ensure this component exists and props match
  ...
  const fetchDealers = useCallback(async (pageToFetch: number) => {
    ...
    try {
      ...
      const formattedDealers: FormattedDealerForCard[] = data.dealers.map((dealer: Dealer) => ({
        _id: dealer._id,
        dealerImageSrc: dealer.profileImage || '/images/default-dealer.jpg', // Ensure path is correct
